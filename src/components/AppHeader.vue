        ...
        >
          ...
          <div class="relative z-20 w-full flex justify-between lg:w-max md:px-0">
            <a href="#home" aria-label="logo" class="flex space-x-2 items-center">
              <div aria-hidden="true" class="flex space-x-1">
                ...
                <div class="h-6 w-2 bg-indigo-500"></div>
              </div>
              <span class="text-2xl font-bold text-gray-900 dark:text-white">Riflesso</span>
            </a>
          ...
          >
            ...
            <div class="mt-12 lg:mt-0">
              <router-link
                to="/playground"
                class="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-indigo-500 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
              >
                <span class="relative text-sm font-semibold text-white">Just Play!</span>
              </router-link>
            </div>
          </div>
        </div>
