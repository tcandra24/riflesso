    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
      ...
      <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
        ...
        >
          ...
          <p class="mt-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum aliquid quo eum quae quos
            illo earum ipsa doloribus nostrum minus libero aspernatur laborum cum, a suscipit,
            ratione ea totam ullam! Lorem ipsum dolor sit amet consectetur, adipisicing elit.
            Architecto laboriosam deleniti aperiam ab veniam sint non cumque quis tempore
        ...
        >
          <div class="flex gap-4">
            <img
              class="w-12 h-12 rounded-full"
              src="../assets/images/avatars/avatar-1.webp"
              alt="user avatar"
              width="200"
              height="200"
              loading="lazy"
        ...
        >
          <div class="flex gap-4">
            <img
              class="w-12 h-12 rounded-full"
              src="../assets/images/avatars/avatar-2.webp"
              alt="user avatar"
              width="200"
              height="200"
              loading="lazy"
          ...
          <p class="mt-8">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Architecto laboriosam deleniti
        ...
        >
          <div class="flex gap-4">
            <img
              class="w-12 h-12 rounded-full"
              src="../assets/images/avatars/avatar-3.webp"
              alt="user avatar"
              width="200"
              height="200"
              loading="lazy"
        ...
        >
          <div class="flex gap-4">
            <img
              class="w-12 h-12 rounded-full"
              src="../assets/images/avatars/avatar-4.webp"
              alt="user avatar"
              width="200"
              height="200"
              loading="lazy"
